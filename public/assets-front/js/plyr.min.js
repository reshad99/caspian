"object" == typeof navigator &&
    (function (e, t) {
            ...
            _ = (function () {
                function e(t, i) {
                    (function (e, t) {
                        ...
                        E(this.element) && M(this.element.rangeTouch) && ((this.config = p({}, f, {}, i)), this.init());
                }
                return (
                    (function (e, t, i) {
        ...
        var Se,
            Pe = { "audio/ogg": "vorbis", "audio/wav": "1", "video/webm": "vp8, vorbis", "video/mp4": "avc1.42E01E, mp4a.40.2", "video/ogg": "theora" },
            Ee = {
        ...
        var nt = {
            ...
            findElements: function () {
                try {
                    return (
                        ...
                        (this.elements.inputs = { seek: Ce.call(this, this.config.selectors.inputs.seek), volume: Ce.call(this, this.config.selectors.inputs.volume) }),
                ...
                switch (
                    ...
                    Object.keys(n).includes("class")
                        ? n.class.split(" ").some(function (e) {
                          ...
                          }) || ce(n, { class: "".concat(n.class, " ").concat(this.config.classNames.control) })
            ...
            createRange: function (e, t) {
                var i = he(
                    ...
                    ce(
                        ...
                        { type: "range", min: 0, max: 100, step: 0.01, value: 0, autocomplete: "off", role: "slider", "aria-label": Xe(e, this.config), "aria-valuemin": 0, "aria-valuemax": 100, "aria-valuenow": 0 },
                        t
                    )
                );
                    ...
                    function (n) {
                        if ([32, 38, 39, 40].includes(n.which) && (n.preventDefault(), n.stopPropagation(), "keydown" !== n.type)) {
                            ...
                            if (!s && [32, 39].includes(n.which)) nt.showMenuPanel.call(i, t, !0);
                                ...
                                32 !== n.which &&
                                    (40 === n.which || (s && 39 === n.which) ? ((a = e.nextElementSibling), G(a) || (a = e.parentNode.firstElementChild)) : ((a = e.previousElementSibling), G(a) || (a = e.parentNode.lastElementChild)),
                                    Ae.call(i, a, !0));
                        }
                    },
                    !1
            ...
            updateVolume: function () {
                this.supported.ui &&
                    (G(this.elements.inputs.volume) && nt.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
                ...
                if (G(this.elements.settings.panels.quality)) {
                    ...
                    if ((nt.toggleMenuButton.call(this, i, a), fe(n), nt.checkMenu.call(this), a)) {
                        ...
                        this.options.quality
                            ...
                            .forEach(function (e) {
                                nt.createMenuItem.call(t, { value: e, list: n, type: i, title: nt.getLabel.call(t, "quality", e), badge: s(e) });
                            }),
                ...
                if (G(this.elements.settings.panels.captions)) {
                    ...
                    if ((nt.toggleMenuButton.call(this, t, a), fe(i), nt.checkMenu.call(this), a)) {
                        var s = n.map(function (t, n) {
                            return { value: n, checked: e.captions.toggled && e.currentTrack === n, title: rt.getLabel.call(e, t), badge: t.language && nt.createBadge.call(e, t.language.toUpperCase()), list: i, type: "language" };
                        });
                ...
                return (
                    Be($(this.config.controls) ? this.config.controls : []).forEach(function (o) {
                        ...
                        if (("current-time" === o && u.appendChild(r.call(t, "currentTime", d)), "duration" === o && u.appendChild(r.call(t, "duration", d)), "mute" === o || "volume" === o)) {
                            ...
                            if (
                                ((G(p) && u.contains(p)) || ((p = he("div", ce({}, d, { class: "".concat(d.class, " plyr__volume").trim() }))), (t.elements.volume = p), u.appendChild(p)),
            ...
            inject: function () {
                ...
                X(this.config.controls) && (this.config.controls = this.config.controls.call(this, n)),
                    ...
                    G(this.config.controls) || Y(this.config.controls)
                        ...
                        : ((i = nt.create.call(this, { id: this.id, seektime: this.config.seekTime, speed: this.speed, quality: this.quality, captions: rt.getLabel.call(this) })), (a = !1));
                var s, r;
                if (
                    (a &&
                    ...
                    return i && this.poster
                        ...
                        : (this.media.setAttribute("data-poster", e),
                          ...
                          je
                              ...
                              .then(function () {
                                  return Object.assign(t.elements.poster.style, { backgroundImage: "url('".concat(e, "')"), backgroundSize: "" }), yt.togglePoster.call(t, !0), e;
                              }));
                },
        ...
        var bt = (function (e, t) {
            ...
            e.exports = (function () {
                ...
                function o(t, i, n, a) {
                    ...
                    (a = a || 0),
                        /(^css!|\.css$)/.test(h)
                            ? (((r = l.createElement("link")).rel = "stylesheet"), (r.href = m), (s = "hideFocus" in r) && r.relList && ((s = 0), (r.rel = "preload"), (r.as = "style")))
        ...
        var Tt = {
            ...
            ready: function () {
                ...
                if ((m.setAttribute("src", p), m.setAttribute("allowfullscreen", ""), m.setAttribute("allow", "autoplay,fullscreen,picture-in-picture"), ae(a) || m.setAttribute("referrerPolicy", a), n || !i.customControls))
                                        ...
                                        case 1:
                                            t.customControls && !e.config.autoplay && e.media.paused && !e.embed.hasPlayed
                                                ...
                                                : (Ct.call(e, !0),
                                                  ...
                                                  e.media.duration !== n.getDuration() && ((e.media.duration = n.getDuration()), Oe.call(e, e.media, "durationchange")));
                                            break;
                                        case 2:
                    ...
                    this.media
                        ? (be(this.elements.container, this.config.classNames.type.replace("{0}", this.type), !0),
                          ...
                          this.isVideo &&
                              ...
                              (this.elements.poster = he("div", { class: this.config.classNames.poster, hidden: "" })),
                              this.elements.wrapper.appendChild(this.elements.poster)),
                          this.isHTML5 ? Ve.setup.call(this) : this.isYouTube ? St.setup.call(this) : this.isVimeo && Tt.setup.call(this))
                ...
                return (
                    i(t, [
                        ...
                        },
                        {
                            key: "render",
                            value: function () {
                                (this.elements.thumb.container = he("div", { class: this.player.config.classNames.previewThumbnails.thumbContainer })),
                                    (this.elements.thumb.imageContainer = he("div", { class: this.player.config.classNames.previewThumbnails.imageContainer })),
                                ...
                                (this.elements.thumb.time = he("span", {}, "00:00")),
                                    ...
                                    (this.elements.scrubbing.container = he("div", { class: this.player.config.classNames.previewThumbnails.scrubbingContainer })),
                        ...
                        },
                        {
                            ...
                            get: function () {
                                return this.mouseDown
                                    ? Nt(this.thumbAspectRatio, { width: this.player.media.clientWidth, height: this.player.media.clientHeight }).height
                          ...
                          this.destroy.call(
                              ...
                              function () {
                                  ...
                                  var i = e.sources,
                                      ...
                                      c = "html5" === r ? n : "div",
                                      u = "html5" === r ? {} : { src: l };
                                  Object.assign(t, { provider: r, type: n, supported: Ee.check(n, r, t.config.playsinline), media: he(c, u) }),
                                ...
                                (this.supported = Ee.check(this.type, this.provider, this.config.playsinline)),
                                    this.supported.api
                                        ? ((this.eventListeners = []),
                                          ...
                                          G(this.elements.container) || ((this.elements.container = he("div", { tabindex: 0 })), ue(this.media, this.elements.container)),
                                    ...
                                    if (this.ready) {
                                        ...
                                        this.stop(),
                                            ...
                                            this.isHTML5
                                                ...
                                                : this.isYouTube
                                                ? (clearInterval(this.timers.buffering), clearInterval(this.timers.playing), null !== this.embed && X(this.embed.destroy) && this.embed.destroy(), n())
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                                        n = null;
                                    return (
                                        Y(e) ? (n = Array.from(document.querySelectorAll(e))) : J(e) ? (n = Array.from(e)) : $(e) && (n = e.filter(G)),
                                        ae(n)
                                            ? null
                                            : n.map(function (e) {
                                                  return new t(e, i);
