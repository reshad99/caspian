...
var KTAppEcommerceSaveCategory = function () {
    ...
    return {
        init: function () {
            ["#kt_ecommerce_add_category_description", "#kt_ecommerce_add_privacy_description_en", "#kt_ecommerce_add_privacy_description_ru", "#kt_ecommerce_add_category_meta_description"].forEach((e => {
