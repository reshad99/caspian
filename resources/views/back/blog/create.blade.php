        ...
        <div class="card card-flush py-4">
          ...
          <div class="card-body pt-0">
            ...
            <div class="mb-1 fv-row">
              ...
              <!--end::Label-->
              <!--begin::Input-->
              <input type="text" class="form-control mb-2" id="instagram" name="instagram" value="" />
              <!--end::Input-->
            </div>
            <!--end::Input group-->
            <!--begin::Input group-->
            <div class="mb-1 fv-row">
              ...
              <!--end::Label-->
              <!--begin::Input-->
              <input type="text" class="form-control mb-2" id="tiktok" name="tiktok" value="" />
              <!--end::Input-->
            </div>
            <!--end::Input group-->
            <!--begin::Input group-->
            <div class="mb-1 fv-row">
              ...
              <!--end::Label-->
              <!--begin::Input-->
              <input type="text" class="form-control mb-2" id="youtube" name="youtube" value="" />
              <!--end::Input-->
            </div>
            <!--end::Input group-->
            <!--begin::Input group-->
            <div class="mb-1 fv-row">
              ...
              <!--end::Label-->
              <!--begin::Input-->
              <input type="text" class="form-control mb-2" id="twitter" name="twitter" value="" />
              <!--end::Input-->
            </div>
            <!--end::Input group-->
            <!--begin::Input group-->
            <div class="mb-1 fv-row">
              ...
              <!--end::Label-->
              <!--begin::Input-->
              <input type="text" class="form-control mb-2" id="facebook" name="facebook" value="" />
              <!--end::Input-->
            </div>
            <!--end::Input group-->
          </div>
