        ...
        <div class="card card-flush py-4">
          ...
          <div class="card-body pt-0">
            ...
            <div class="mb-1 fv-row">
              ...
              <!--end::Label-->
              <!--begin::Input-->
              <input type="text" class="form-control mb-2" id="name" name="name" value="{{ $song->name }}" />
              <!--end::Input-->
            </div>
            <!--end::Input group-->
            <!--begin::Input group-->
            <div class="mb-1 fv-row">
              ...
              <!--end::Label-->
              <!--begin::Input-->
              <input type="text" class="form-control mb-2" placeholder="0:00" id="duration" name="duration" value="{{ $song->duration }}" />
              <!--end::Input-->
            </div>
            <!--end::Input group-->
            <!--begin::Input group-->
            <div class="mb-1 fv-row">
              ...
              <select name="artist_id" id="artist_id" class="form-control">
                ...
                <option value="{{ $a->id }}" @if ($a->id == $song->artist_id) selected @endif>{{ $a->name }}</option>
                @endforeach
              </select>
              <!--end::Input-->
            </div>
            ...
            <div class="card card-flush py-4">
              ...
              <div class="card-body text-center pt-0">
                <!--begin::Image input-->
                <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="background-image: url('{{ $song->photo }}')">
