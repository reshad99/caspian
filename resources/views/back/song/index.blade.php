    ...
    <div class="card card-flush">
      ...
      <div class="card-header align-items-center py-5 gap-2 gap-md-5">
        ...
        <div class="card-toolbar">
          <!--begin::Add customer-->
          <a href="/admin/{{ Request::segment(2) }}/create" class="btn btn-primary">Mahnı əlavə et</a>
          <!--end::Add customer-->
        </div>
        <!--end::Card toolbar-->
      </div>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" data-table="{{ Request::segment(2) }}" id="kt_ecommerce_category_table">
          ...
          <thead>
            ...
            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
              <th class="min-w-250px">Mahnının adı</th>
              <th class="text-center min-w-250px">Artist</th>
              <th class="text-center min-w-250px">Top</th>
            ...
            @foreach ($songs as $s)
                 ...
                 <!--begin::Category=-->
                  <td>
                    <div class="d-flex align-items-center">
                      <!--begin::Thumbnail-->
                      <a href="{{route('songs.edit', ['song' => $s->id])}}" class="symbol symbol-50px">
                        <span class="symbol-label" style="background-image:url('{{ $s->photo }}');"></span>
                      </a>
                      <!--end::Thumbnail-->
                      <div class="ms-5">
                        <!--begin::Title-->
                        <a href="{{route('songs.edit', ['song' => $s->id])}}" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">{{$s->name}}</a>
                        <!--end::Title-->
                      </div>
                    </div>
                  </td>
                ...
                <td class="text-center pe-0">
                  ...
                  <label class="form-check d-block form-switch form-check-custom form-check-solid">
                    <input class="form-check-input top_check" type="checkbox" name="excise" data-id="{{ $s->id }}" @if($s->top == true) checked @endif style="border-color: red;">
                ...
                <!--end::Price=-->
                  ...
                  <a href="/admin/{{ Request::segment(2) }}/{{ $s->id }}/edit" >
