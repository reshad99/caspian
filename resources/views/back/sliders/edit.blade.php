              ...
              <div class="d-flex flex-column gap-7 gap-lg-10">
                ...
                <div class="card card-flush py-4">
                  ...
                  <div class="mb-10 fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="title" id="title" class="form-control mb-2" placeholder="Title" value="{{ $slider->title }}" />
                    <!--end::Input-->
                  </div>
                  <!--end::Input group-->
                  <!--begin::Input group-->
                  <div class="mb-10 fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <textarea name="text" id="text" class="form-control" cols="30" rows="10">{!! $slider->text !!}</textarea>
                    <!--end::Input-->
                  </div>
                  <!--end::Input group-->
                  <!--begin::Input group-->
                  <div class="mb-10 fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="link" id="link" class="form-control mb-2" placeholder="Link" value="{{ $slider->link }}" />
                    <!--end::Input-->
                  </div>
                  <!--end::Input group-->
                </div>
