    ...
    <div class="card card-flush">
      ...
      <div class="card-header align-items-center py-5 gap-2 gap-md-5">
        ...
        <div class="card-toolbar">
          <!--begin::Add customer-->
          <a href="/admin/{{ Request::segment(2) }}/create" class="btn btn-primary">Artist əlavə et</a>
          <!--end::Add customer-->
        </div>
        <!--end::Card toolbar-->
      </div>
                ...
                <tr id="tr-{{$a->id}}">
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <!--begin::Thumbnail-->
                      <a href="{{route('artists.edit', ['artist' => $a->id])}}" class="symbol symbol-50px">
                        <span class="symbol-label" style="background-image:url('{{ $a->photo }}');"></span>
                      </a>
                      <!--end::Thumbnail-->
                      <div class="ms-5">
                        <!--begin::Title-->
                        <a href="{{route('artists.edit', ['artist' => $a->id])}}" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">{{$a->name}}</a>
                        <!--end::Title-->
                        <!--begin::Description-->
