    ...
    <div class="card card-flush">
      ...
      <div class="card-header align-items-center py-5 gap-2 gap-md-5">
        ...
        <div class="card-toolbar">
          <!--begin::Add customer-->
          <a href="/admin/{{ Request::segment(2) }}/create" class="btn btn-primary">Əlavə et</a>
          <!--end::Add customer-->
        </div>
        <!--end::Card toolbar-->
      </div>
                ...
                <tr id="tr-{{$c->id}}">
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <div class="ms-5">
                        <!--begin::Title-->
                        <a href="{{route('categories.edit', ['category' => $c->id])}}" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">{{$c->name}}</a>
                        <!--end::Title-->
                      </div>
                    </div>
                  </td>
                  ...
                  <a href="/admin/{{ Request::segment(2) }}/{{ $c->id }}/edit" >
                  ...
                  <!--begin::Svg Icon | path: assets/media/icons/duotune/arrows/arr015.svg-->
                      <a href="javascript:void(0)" data-id="{{ $c->id }}" class="delete" data-table="{{ Request::segment(2) }}">
