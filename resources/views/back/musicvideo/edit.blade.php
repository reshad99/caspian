        ...
        <div class="card card-flush py-4">
          ...
          <div class="card-body pt-0">
            ...
            <div class="mb-1 fv-row">
              ...
              <!--end::Label-->
              <!--begin::Input-->
              <input type="text" class="form-control mb-2" id="link" name="link" value="{{ $video->link }}" />
              <!--end::Input-->
            </div>
            <!--end::Input group-->
            <!--begin::Input group-->
            <div class="mb-1 fv-row">
              <!--begin::Label-->
              <label class="required form-label">Klipin adı</label>
              <!--end::Label-->
              <!--begin::Input-->
              <input type="text" class="form-control mb-2" id="name" name="name" value="{{ $video->name }}" />
              <!--end::Input-->
            </div>
            <!--end::Input group-->
            <!--begin::Input group-->
            <div class="mb-1 fv-row">
              <!--begin::Label-->
              <label class="required form-label">Artistlər</label>
              <!--end::Label-->
              <!--begin::Input-->
              <select name="artist_id" id="artist_id" class="form-control">
                <option value="">Seç</option>
                @foreach ($artists as $a)
                <option value="{{ $a->id }}" @if($a->id == $video->artist_id) selected @endif>{{ $a->name }}</option>
                @endforeach
              </select>
              <!--end::Input-->
            </div>
