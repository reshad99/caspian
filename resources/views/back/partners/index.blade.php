      ...
      <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
          ...
          <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
            <!--begin::Add product-->
            <a href="partners/create" class="btn btn-primary">Partnyor əlavə et</a>
            <!--end::Add product-->
          </div>
          <!--end::Card toolbar-->
        </div>
          ...
          <table class="table align-middle table-row-dashed fs-6 gy-5" data-table="partners" id="kt_ecommerce_products_table">
            ...
            <thead>
              ...
              <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                <th class="text-center min-w-200px">Partnyor</th>
            ...
            <tbody class="fw-bold text-gray-600 append_div">
              ...
              <tr id="tr-{{$p->id}}">
                ...
                <td class="text-center">
                    <img src="{{ $p->logo }}" style="width: 200px" alt="">
                </td>
                <!--end::Category=-->
                <!--begin::Action=-->
                <td class="text-end">
                  ...
                  <span class="svg-icon svg-icon-primary svg-icon-2hx"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <a href="javascript:void(0)" data-id="{{ $p->id }}" class="delete" data-table="partners">
