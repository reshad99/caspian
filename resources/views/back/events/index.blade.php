    ...
    <div class="card card-flush">
      ...
      <div class="card-header align-items-center py-5 gap-2 gap-md-5">
        ...
        <div class="card-toolbar">
          <!--begin::Add customer-->
          <a href="/admin/{{ Request::segment(2) }}/create" class="btn btn-primary">Tədbir əlavə et</a>
          <!--end::Add customer-->
        </div>
        <!--end::Card toolbar-->
      </div>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" data-table="{{ Request::segment(2) }}" id="kt_ecommerce_category_table">
          ...
          <thead>
            ...
            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
              <th class="min-w-250px">Başlıq</th>
              <th class="text-center min-w-250px">Artist</th>
              <th class="text-center min-w-250px">Keçiriləcəyi tarix</th>
                ...
                <tr id="tr-{{$e->id}}">
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <!--begin::Thumbnail-->
                      <a href="{{route('events.edit', ['event' => $e->id])}}" class="symbol symbol-50px">
                        <span class="symbol-label" style="background-image:url('{{ $e->photo }}');"></span>
                      </a>
                      <!--end::Thumbnail-->
                      <div class="ms-5">
                        <!--begin::Title-->
                        <a href="{{route('events.edit', ['event' => $e->id])}}" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">{{$e->title}}</a>
                        <!--end::Title-->
                      </div>
                    </div>
                  </td>
                  ...
                  <a href="/admin/{{ Request::segment(2) }}/{{ $e->id }}/edit" >
                  ...
                  <!--begin::Svg Icon | path: assets/media/icons/duotune/arrows/arr015.svg-->
                      <a href="javascript:void(0)" data-id="{{ $e->id }}" class="delete" data-table="{{ Request::segment(2) }}">
