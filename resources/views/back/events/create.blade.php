        ...
        <div class="card card-flush py-4">
          ...
          <div class="card-body pt-0">
            ...
            <div class="mb-1 fv-row">
              ...
              <!--end::Label-->
              <!--begin::Input-->
              <input type="text" class="form-control mb-2" id="artist" name="artist" value="" />
              <!--end::Input-->
            </div>
            <!--end::Input group-->
            <!--begin::Input group-->
            <div class="mb-1 fv-row">
              ...
              <!--end::Label-->
              <!--begin::Input-->
              <input type="text" class="form-control mb-2" id="location" name="location" value="" />
              <!--end::Input-->
            </div>
            <!--end::Input group-->
            <!--begin::Input group-->
            <div class="mb-1 fv-row">
              ...
              <!--end::Label-->
              <!--begin::Input-->
              <input type="text" class="form-control mb-2" id="location_link" name="location_link" value="" />
              <!--end::Input-->
            </div>
            <!--end::Input group-->
            <!--begin::Input group-->
            ...
            <div class="mb-1 fv-row">
              ...
              <!--end::Label-->
              <!--begin::Input-->
              <input type="text" class="form-control mb-2" id="time" name="time" placeholder="00:00"/>
              <!--end::Input-->
            </div>
            <!--end::Input group-->
            <!--begin::Input group-->
